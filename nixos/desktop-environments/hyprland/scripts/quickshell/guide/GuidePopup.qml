...
Item {
    ...
    function buildKeybinds() {
        ...
        let binds = [
            { k1: "SUPER", k2: "RETURN", action: "Open Terminal (Ghostty)", cmd: "ghostty" },
            { k1: "CTRL+ALT", k2: "T", action: "Open Terminal (Ghostty)", cmd: "ghostty" },
            { k1: "SUPER", k2: "B", action: "Open Firefox", cmd: "firefox" },
            { k1: "SUPER", k2: "E", action: "Open Thunar", cmd: "thunar" },
            { k1: "SUPER+SHIFT", k2: "V", action: "Open Volume Mixer", cmd: "pavucontrol" },

            { k1: "SUPER", k2: "D", action: "App Launcher", cmd: "bash ~/.config/hypr/scripts/rofi_show.sh drun" },
            ...
            { k1: "SUPER", k2: "F", action: "Toggle Fullscreen", cmd: "hyprctl dispatch fullscreen" },
            { k1: "ALT", k2: "F4", action: "Close Active Window", cmd: "hyprctl dispatch killactive" },

            { k1: "SUPER", k2: "M", action: "Toggle Monitors Widget", cmd: "bash ~/.config/hypr/scripts/qs_manager.sh toggle monitors" },
            { k1: "SUPER+SHIFT", k2: "S", action: "Toggle Stewart Widget", cmd: "bash ~/.config/hypr/scripts/qs_manager.sh toggle stewart" },
            { k1: "SUPER", k2: "Q", action: "Toggle Music Widget", cmd: "bash ~/.config/hypr/scripts/qs_manager.sh toggle music" },
            { k1: "SUPER", k2: "W", action: "Toggle Wallpaper Widget", cmd: "bash ~/.config/hypr/scripts/qs_manager.sh toggle wallpaper" },
            ...
            { k1: "SUPER+SHIFT", k2: "T", action: "Toggle FocusTime Widget", cmd: "bash ~/.config/hypr/scripts/qs_manager.sh toggle focustime" },
            { k1: "SUPER", k2: "V", action: "Toggle Volume Widget", cmd: "bash ~/.config/hypr/scripts/qs_manager.sh toggle volume" },
            { k1: "SUPER", k2: "H", action: "Toggle Guide Widget", cmd: "bash ~/.config/hypr/scripts/qs_manager.sh toggle guide" },
            ...
            { k1: "Media", k2: "Play/Pause", action: "Toggle Playback", cmd: "playerctl play-pause" },
            { k1: "Media", k2: "Next/Prev", action: "Track Skip", cmd: "playerctl next" },
            { k1: "Media", k2: "Vol Up/Down", action: "Adjust Volume", cmd: "swayosd-client --output-volume raise" },
            { k1: "Media", k2: "Mute", action: "Mute Output", cmd: "swayosd-client --output-volume mute-toggle" },
            ...
            { k1: "CAPS", k2: "LOCK", action: "Show Caps Lock OSD", cmd: "swayosd-client --caps-lock" },
            ...
            { k1: "SUPER", k2: "1-0", action: "Switch Workspace 1-10", cmd: "bash ~/.config/hypr/scripts/qs_manager.sh 1" },
            { k1: "SUPER+SHIFT", k2: "1-0", action: "Move to Workspace 1-10", cmd: "bash ~/.config/hypr/scripts/qs_manager.sh 1 move" }
        ];
